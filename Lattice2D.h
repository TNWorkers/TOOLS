...
public:
	...
	bool ARE_NEIGHBORS(Site i, Site j, std::string atom_i, std::string atom_j, size_t range=1) const;
...
bool Lattice2D::
ARE_NEIGHBORS(Site i, Site j, std::string atom_i="", std::string atom_j="", size_t range) const
{
